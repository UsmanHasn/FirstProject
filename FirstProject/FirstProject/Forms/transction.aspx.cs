...
namespace FirstProject
{
    ...
    public partial class transction : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                if (Session["User"] != null)
                {
                    ...
                    lbluser.Style.Add("Color", "green");
                    // lbluser.Text = "Login Successfull";
                }
                else
                {
        ...
        void getdata()
        {
            adp = new SqlDataAdapter("sp_pratice", Conn);
            adp.SelectCommand.CommandType = CommandType.StoredProcedure;
            adp.SelectCommand.Parameters.AddWithValue("@Action", 'a');
            dt = new DataTable();
            adp.Fill(dt);
        ...
        protected void gridCrud_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            txtcusref.Text = gridCrud.Rows[e.RowIndex].FindControl("txtcusrefno") as TextBox;
        ...
        protected void gridCrud_RowDataBound(object sender, GridViewRowEventArgs e)
        {
        ...
        protected void btnsearch_Click(object sender, EventArgs e)
        {
            if (Session["Authorizer"].ToString() == "0")
            {
                ...
                Sp_crud(var_id, var_cusrefno, txtbeneficiaryName.Text, "admin", DropDownSender.SelectedValue.ToString(), txtfrmdate.Text, txttodate.Text);
            ...
            else if (Session["Authorizer"].ToString() == "1")
            {
                ...
                Sp_crud(var_id, var_cusrefno, txtbeneficiaryName.Text, "maker", DropDownSender.SelectedValue.ToString(), txtfrmdate.Text, txttodate.Text);
